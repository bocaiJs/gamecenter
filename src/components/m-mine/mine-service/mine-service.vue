    ...
    <div class="service">
      ...
      >
        ...
        <div class="module">
          ...
          <div
            class="item"
            :class="{'active':showIndex ==6 &&isItemOpen}"
            @click="showItem(6)"
          >
            <span class="arrow"></span>如何进入微信客服平台？
            <p>
              点击下方“微信客服平台”复制公众号名称“天橙游玩”，打开微信，搜索-添加-关注公众号，进入微信客服平台。
            </p>
          </div>
        </div>
        <div class="contact">
